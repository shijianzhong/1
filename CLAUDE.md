...
| 7 工具与 MCP | ⏳ 进行中 | memory/propose/ask_user/web/file/opencli 已落地（file_* 已全量异步化）；**Skill ContextProvider + skill_run_script 已落地（7.4 ✅ 2026-08-03）**；**向量知识库 P0 地基 + P1 摄取管线已落地（7.5 ✅ 2026-08-20，`kb:add/list/remove` IPC + pipeline 分块 + v11 content 列）**；shell/browser_use/MCP 未做 |
