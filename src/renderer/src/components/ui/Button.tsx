...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-[var(--color-brand-500)] text-[var(--color-on-brand)] hover:bg-[var(--color-brand-600)]',
        ...
        danger: 'bg-[var(--color-danger)] text-[var(--color-on-brand)] hover:opacity-90',
      },
      size: {
        default: 'h-9 px-4',
        sm: 'h-8 px-3 text-xs',
